...
namespace AmplifyShaderEditor
{
	...
	public sealed class TemplateMultiPassMasterNode : MasterNode
	{
		...
		public void CollectData()
		{
			...
			// DotsDefinesList 里面记录了具体的property
			if( m_currentDataCollector.DotsDefinesList.Count > 0 )
			{
				...
				m_currentDataCollector.DotsPropertiesList.Insert( 0, new PropertyDataCollector( -1, "#if defined(UNITY_HYBRID_V1_INSTANCING_ENABLED)" ) );
				string condition = 
...
+"#endif";
				m_currentDataCollector.DotsPropertiesList.Insert( 0, new PropertyDataCollector( -1, condition ) );
