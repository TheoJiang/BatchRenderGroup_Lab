...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/ASETemplateShaders/SemiTransparentCore", false, 85 )]
		public static void ApplyTemplateASETemplateShadersSemiTransparentCore()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "807e8c78eebcdb2418582d210407af3d" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/ASETemplateShaders/SkyboxCore", false, 85 )]
		public static void ApplyTemplateASETemplateShadersSkyboxCore()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "c7204bd1da0acac4e817d44e54e27aeb" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/XDT/Universal/CommonPBRTemplate", false, 85 )]
		public static void ApplyTemplateXDTUniversalCommonPBRTemplate()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "a952b6758cf769449927a8b9b9fa845d" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/XDT/Universal/UnlitTemplate", false, 85 )]
		public static void ApplyTemplateXDTUniversalUnlitTemplate()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "796eb0b09ed641c4fae2b6c809074c16" );
		}
