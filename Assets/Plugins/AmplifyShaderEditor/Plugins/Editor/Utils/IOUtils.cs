...
namespace AmplifyShaderEditor
{
	...
	public static class IOUtils
	{
		...
		// public static readonly string DotsInstancedPropertiesData = "\tUNITY_DOTS_INSTANCED_PROP({0}, {1})";
		public static readonly string DotsInstancedDefinesData0 = "#define HYBRID_V1_CUSTOM_ADDITIONAL_MATERIAL_VARS	UNITY_DEFINE_INSTANCED_PROP({0} , {1}_Array)";
		public static readonly string DotsInstancedDefinesData1 = "#define {0} UNITY_ACCESS_INSTANCED_PROP(unity_Builtins0 , {0}_Array)";
