...
namespace AmplifyShaderEditor
{
	...
	public sealed class LinearDepthNode : ParentNode
	{
		...
		private const string LinearEyeFuncFormat_SRP = "LinearEyeDepth({0},_ZBufferParams)";
		private const string Linear01FuncFormat = "Linear01Depth({0})";
		private const string Linear01FuncFormat_SRP = "Linear01Depth({0},_ZBufferParams)";
		...
		public override string GenerateShaderForOutput( int outputId, ref MasterNodeDataCollector dataCollector, bool ignoreLocalvar )
		{
			...
			value = string.Format( (( m_currentOption == 0 ) ? (( dataCollector.IsTemplate && dataCollector.IsSRP ) ? LinearEyeFuncFormat_SRP : LinearEyeFuncFormat)
			 : (( dataCollector.IsTemplate && dataCollector.IsSRP ) ? Linear01FuncFormat_SRP : Linear01FuncFormat)), value );
